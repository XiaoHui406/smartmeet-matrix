import { ZegoScenario, ZegoPublishChannel, ZegoUser, ZegoRoomConfig, ZegoMediaPlayer, ZegoEngineProfile, ZegoIMSendCustomCommandResult, ZegoPublisherUpdateCdnUrlResult, ZegoMixerTask, ZegoMixerStopResult, ZegoEffectsBeautyParam, ZegoRoomMode, ZegoAutoMixerTask, ZegoRoomSetRoomExtraInfoResult, ZegoVideoConfig, ZegoMixerStartResult, ZegoIMSendBroadcastMessageResult, ZegoIMSendBarrageMessageResult, ZegoVideoConfigPreset } from "./ZegoExpressDefines";
...
export default class ZegoExpressEngine {
     ...
     */
    private zegoWebRTC;
    static _instance: ZegoExpressEngine | null;
    static rangeAudioInstance: any;
    private channelData;
    private beautyEnable;
    private beautyParams?;
    private publishOption?;
    private cameraConfig;
    private mediaPlayerMap?;
    static zegoPlayer: any;
    static mediaPlayerIndex: number;
    static instance(): (ZegoExpressEngine | null);
    /**
     * 初始化 Engine
     *
     * Note: 支持版本：1.0.0
     ...
     */
    static destroyEngine(): (Promise<boolean> | void);
    /**
     ...
     */
    getStreamByChannel(channel?: number): Promise<MediaStream>;
    /**
     ...
     */
    on<K extends keyof ZegoEventListener>(event: K, callback: ZegoEventListener[K]): (boolean | void);
    /**
     ...
     * @param callback callback
     */
    off<K extends keyof ZegoEventListener>(event: K, callback?: ZegoEventListener[K]): boolean;
    changeEventName<K extends keyof ZegoEventListener>(event: K): K;
    /**
     ...
     */
    setDummyCaptureImagePath(filePath: string, channel?: ZegoPublishChannel): Promise<boolean>;
    /**
     ...
     */
    loginRoom(roomID: string, user: ZegoUser, config?: ZegoRoomConfig): Promise<boolean>;
    /**
     * Logs out of a room.
     *
     ...
     */
    renewToken(roomID: string, token: string): Promise<boolean>;
    /**
     ...
     */
    startPublishingStream(streamID: string, channel?: ZegoPublishChannel, config?: any): Promise<void>;
    /**
     ...
     */
    startPreview(videoElement: HTMLMediaElement, channel?: ZegoPublishChannel): Promise<void>;
    /**
     ...
     * @param {ZegoPublishChannel} channel - Publish stream channel. [Main] as default.
     */
    mutePublishStreamAudio(mute: boolean, channel?: ZegoPublishChannel): Promise<boolean>;
    /**
     ...
     * @param {ZegoPublishChannel} channel - Publish stream channel. [Main] as default.
     */
    mutePublishStreamVideo(mute: boolean, channel?: ZegoPublishChannel): Promise<boolean>;
    /**
     ...
     * @param {ZegoPublishChannel} channel Publish stream channel. [Main] as default.
     */
    setMinVideoBitrateForTrafficControl(): any;
    /**
     ...
     */
    startPlayingStream(streamID: string, config?: any): Promise<void>;
    /**
     ...
     */
    setPlayVolume(streamID: string, volume: number): any;
    /**
     ...
     */
    setPlayStreamBufferIntervalRange(): any;
    /**
     ...
     */
    muteAllPlayStreamVideo(mute: boolean): any;
    /**
     ...
     */
    stopAutoMixerTask(task: ZegoAutoMixerTask): any;
    /**
     ...
     */
    enableAudioCaptureDevice(enable: boolean): any;
    /**
     ...
     */
    enableCamera(enable: boolean, channel?: ZegoPublishChannel): Promise<boolean>;
    /**
     ...
     */
    setAudioRouteToSpeaker(defaultToSpeaker: boolean): any;
    /**
     * Get current audio route type
     *
     * @return {ZegoAudioRoute} Audio route
     */
    getAudioRouteType(): any;
    /**
     ...
     */
    createMediaPlayer(): Promise<MediaPlayer>;
    /**
